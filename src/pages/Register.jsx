      ...
      <div className="max-w-2xl w-full">
        <div className="bg-dark-card rounded-2xl shadow-glow-orange border border-dark-border p-8 animate-fadeIn">
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center space-x-2 border border-dark-border bg-dark-bg py-3 rounded-lg hover:border-primary/50 hover:bg-dark-bg/50 transition-all group">
            ...
            <button className="w-full flex items-center justify-center space-x-2 border border-dark-border bg-dark-bg py-3 rounded-lg hover:border-primary/50 hover:bg-dark-bg/50 transition-all group">
              ...
              <span className="text-text-primary font-medium group-hover:text-primary transition-colors">Continue with Facebook</span>
            </button>
          </div>
